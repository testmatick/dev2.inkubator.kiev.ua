...
$_['text_account_already']      = 'Якщо у Вас вже є партнерський логін, будь ласка <a href="%s">авторизуйтеся</a>.';
...
$_['entry_tax']                 = 'Індивідуальний Ідентифікаційний Номер';
...
$_['error_confirm']             = 'Пароль і Пароль підтвердження не співпадають!';
...
$_['error_agree']               = 'Увага. Ви повинні прочитати і погодиться %s!';
