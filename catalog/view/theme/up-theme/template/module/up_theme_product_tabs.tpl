        ...
        <div class="col-sm-12">
          <ul id="tabs-<?php echo $module; ?>" class="nav nav-tabs">
           <?php if($featured_products) { ?>
            <li class="active  pt"><a href="#tab-featured-<?php echo $module; ?>" data-toggle="tab"><?php echo $text_featured; ?></a></li>
            <?php } ?>
            <?php if($latest_products) { ?>
            <li class="pt"><a href="#tab-latest-<?php echo $module; ?>" data-toggle="tab"><?php echo $text_latest; ?></a></li>
            <?php } ?>
...
<?php if($featured_products){ ?>
  <div id="tab-featured-<?php echo $module; ?>" class="row product-items fade in tab-pane active">
...
<?php if($latest_products){ ?>
<div id="tab-latest-<?php echo $module; ?>" class="row product-items fade tab-pane">
