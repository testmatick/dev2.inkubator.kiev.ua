...
<div class="panel panel-default product-module">
  ...
  <div class="product-items product-items-most-viewed product-items-<?php echo $config->get('t1o_most_viewed_style'); ?>">
  <?php foreach ($most_viewed as $product) { ?>
  <?php if($config->get('t1o_most_viewed_style') ==1) { ?>
...
$('.product-items-most-viewed').owlCarousel({
	itemsCustom : [
        [0, 1],
        [980, <?php echo $config->get('t1o_most_viewed_per_row'); ?>],
    ],
	singleItem: false,
	pagination: true,
	navigation: false,
