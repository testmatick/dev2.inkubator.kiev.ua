...
<div class="panel panel-default product-module">
  ...
  <div class="product-items product-items-featured product-items-<?php echo $config->get('t1o_featured_style'); ?>">
  <?php foreach ($products as $product) { ?>
  <?php if($config->get('t1o_featured_style') ==1) { ?>
...
$('.product-items-featured').owlCarousel({
	itemsCustom : [
        [0, 1],
        [980, <?php echo $config->get('t1o_featured_per_row'); ?>],
    ],
	singleItem: false,
	pagination: true,
	navigation: false,
