...
define("lang_iso_code","ar");
define("smscurrency","EUR");

define("lang_alphabet","أ ;ب; ت ;ث; ج ;ح ;خ; د; ذ; ر; ز; س; ش ;ص ;ض; ط; ظ ;ع ;غ ;ف ;ق; ك; ل ;م ;ن; هـ ;و; ي");
...
//new
define("v_all_years","جميع السنوات");
define("v_menu_setting", "الإعدادات");
...
// AdminSms.php
define("v_adminsms_adminsms","إرساليات المشرف");
define("v_adminsms_description","تحوير نصوص الرسائل والأوقات التي يتم فيها إشعار المشرفين.");
define("v_adminsms_unicodesms","رسائل اليونيكود");
define("v_adminsms_unicode","يونيكود");
define("v_adminsms_unicodetext","يتم تفعيل هذه الخاصية عند استعمال اللغة العربية أو الصينية أو اليونانية أو العبرية أو الكورية، إلخ. وكذلك عند استخدام الرموز في نص الرسالة (عموما نصوص اليونيكود تُمكِن من استعمال أحرف جميع اللغات بالإضافة الى جميع الرموز، عدد الأحرف الأقصى في نص الرسالة الواحدة يصبح 70 رمزا.");
define("v_adminsms_unicodesave","تفعيل");
define("v_adminsms_smsactive","خاصية إرسال الإشعارات نشطة");
define("v_adminsms_smsnotactive","خاصية إرسال الإشعارات غير نشطة حاليا، لتفعيلها يجب عليك اختيار مشرف واحد على الأقل.");
define("v_adminsms_statusupdate","تحيين حالة الطلبية");
define("v_adminsms_account","انشاء حساب");
define("v_adminsms_product","المنتجات");
define("v_adminsms_orderstatus","حالة الطلبيات");
define("v_adminsms_order","الطلبيات");
define("v_adminsms_adminsmsnotactive","إرساليات المشرف - غير مفعلة");
define("v_adminsms_addadmin","يُرجى اضافة مشرف واحد على الأقل");
define("v_adminsms_usernotactive","الحساب الشخصي غير نشط، للتسجيل يرجى النقر على ايقونة الرسائل، ومن ثمة يمكنك مشاهدة معطيات التسجيل، اذا سبق لك وأن استعملت هذا التطبيق واذا كنت تعرف اسم المستخدم وكلمة السر الخاصين بك يمكنك استخدامهم في هذا الحساب. خلافا لذلك أدخل البريد الإلكتروني الخاص بك ووافق على شروط الخدمة ومن ثمة اظغط على تسجيل.");
define("v_adminsms_invalidtext","نص الرسالة غير صالح");
define("v_adminsms_smssaved","تم تسجيل نص الرسالة");
define("v_adminsms_unicodesaved","تم تفعيل خاصية اليونيكود");
define("v_adminsms_jschar","حرف");
define("v_adminsms_jschars","أحرف");
define("v_adminsms_jslabel","شريحة");
define("v_adminsms_jssmstext","نص الرسالة");
define("v_adminsms_jstotalsms","مجموع الرسائل:");
define("v_adminsms_smstext","أدخل نص الرسالة");
define("v_adminsms_preview","معاينة");
define("v_adminsms_admins","المشرفون");
define("v_adminsms_save","حفظ");
define("v_adminsms_cancel","إلغاء");
define("v_adminsms_restoreunsaved","اعادة التغييرات غير المسجلة إلى حالتها الأصلية"); //new


// AdminSmsProfile.php
define("v_adminsmsprofile_profilenotactive","حساب المشرف - غير نشط");
define("v_adminsmsprofile_profileactive","حساب المشرف - نشط");
define("v_adminsmsprofile_newaccount","حساب جديد");
define("v_adminsmsprofile_notregistered","غير مسجل؟ قم بإنشاء حسابك الآن");
define("v_adminsmsprofile_email","البريد الإلكتروني:");
define("v_adminsmsprofile_company","إسم الشركة:");
define("v_adminsmsprofile_street","الشارع:");
define("v_adminsmsprofile_city","المدينة:");
define("v_adminsmsprofile_zip","الترقيم البريدي");
define("v_adminsmsprofile_country","البلد:");
define("v_adminsmsprofile_id","مُعرف الشركة");
define("v_adminsmsprofile_vat","رقم الحساب الضريبي للشركة");
define("v_adminsmsprofile_refererid","المرجع المعرف");
define("v_adminsmsprofile_licence","الإطلاع على بنود الترخيص");
define("v_adminsmsprofile_agree","موافق");
define("v_adminsmsprofile_notagree","غير موافق");
define("v_adminsmsprofile_register","تسجيل");
define("v_adminsmsprofile_required","حقل مطلوب");
define("v_adminsmsprofile_sign","تسجيل الدخول");
define("v_adminsmsprofile_signtext","إذا كان لديك حساب يمكنك تسجيل الدخول");
define("v_adminsmsprofile_username","إسم المستخدم:");
define("v_adminsmsprofile_password","كلمة السر:");
define("v_adminsmsprofile_login","الدخول");
define("v_adminsmsprofile_editaccount","تحوير حساب المستخدم");
define("v_adminsmsprofile_save","حفظ");
define("v_adminsmsprofile_accountinfo","معلومات الحساب");
define("v_adminsmsprofile_credit","مخزون الرسائل:");
define("v_adminsmsprofile_addadmin","إضافة مشرفين");
define("v_adminsmsprofile_name","الإسم:");
define("v_adminsmsprofile_mobilenr","رقم الهاتف المحمول:");
define("v_adminsmsprofile_edit","تحوير");
define("v_adminsmsprofile_add","إضافة");
define("v_adminsmsprofile_settings","إعدادات أخرى");
define("v_adminsmsprofile_simulate","محاكاة الرسائل القصيرة:");
define("v_adminsmsprofile_simulatehint","السماح باختبار الإرساليات والإطلاع على حالة الرسائل في أرشيف الإرساليات");
define("v_adminsmsprofile_deletedb","حذف قاعدة البيانات");
define("v_adminsmsprofile_deletedbhint","السماح بما اذا كان يجب تخزين الإعدادات و تسجيل قاعدة البيانات إذا ما تم حذف التطبيق");
define("v_adminsmsprofile_report","تقارير الإرسال");
define("v_adminsmsprofile_reporthint","السماح بمشاهدة تقارير بعث الإرساليات في أرشيف الإرساليات");
define("v_adminsmsprofile_lowcredit","التنبيه حول مخزون الإرساليات المنخفض");
define("v_adminsmsprofile_lowcredithint"," السماح باستقبال بريد الكتروني في حالة تدني المخزون");
define("v_adminsmsprofile_dremail","البريد الإلكتروني لتقارير التسليم:");
define("v_adminsmsprofile_dremailhint","السماح بتلقي البريد الالكتروني مع تقرير تسليم الرسائل القصيرة.");
define("v_adminsmsprofile_admincreated","تمت إضافة المشرف");
define("v_adminsmsprofile_agreetext","يجب عليك القبول بشروط الإستعمال");
define("v_adminsmsprofile_accountcreated","تم إنشاء الحساب");
define("v_adminsmsprofile_addaccounttext","يمكنك إضافة حساب آخر لاحقا");
define("v_adminsmsprofile_minutes","دقائق");
define("v_adminsmsprofile_cantconnect","لا يمكن الإتصال بسيرفر الرسائل");
define("v_adminsmsprofile_loginok","تم تسجيل الدخول بنجاح");
define("v_adminsmsprofile_error","خطأ");
define("v_adminsmsprofile_invalidemail","البريد الإكتروني غير صالح لتقارير التسليم");
define("v_adminsmsprofile_invalidemail2","البريد الإلكتروني غير صالح");
define("v_adminsmsprofile_accountchanged","تم تغيير الحساب");
define("v_adminsmsprofile_accountchanged2","تم تغيير الحساب، لكن رابط التطبيق لا يجيب");
define("v_adminsmsprofile_changeaccounttext","يمكنك تغيير اعدادات الحساب فيما بعد ");
define("v_adminsmsprofile_seeconds"," ثوان");
define("v_adminsmsprofile_invalidname","إسم غير صالح");
define("v_adminsmsprofile_invalidnumber","رقم غير صالح");
define("v_adminsmsprofile_adminchanged","تم تغيير المشرف");
define("v_adminsmsprofile_admindeleted","تم حذف المشرف");
define("v_adminsmsprofile_nochanges","لا تغييرات");
define("v_adminsmsprofile_loginerror","خطأ في عملية الدخول");
define("v_adminsmsprofile_confirmdelete","هل أنت متأكد من عملية الحذف");
define("v_adminsmsprofile_deleteadmin","حذف المشرف");
define("v_adminsmsprofile_editadmin","إعدادات المشرف");
define("v_adminsmsprofile_intformat","في الشكل الدولي لا توجد أصفار ولا وجود لعلامة "+" مثلا: 44791796595");
define("v_adminsmsprofile_uninstall","(الغاء التنصيب)");
define("v_adminsmsprofile_noalert","(0 = لا تنبيه)");
define("v_adminsmsprofile_filluser","أضف اسم المستخدم وكلمة السر");

// CustomerSms.php
define("v_customersms_customersms","إرساليات الحريف -");
define("v_customersms_notactive","إرساليات الحريف - غير نشطة");
define("v_customersms_langversion"," صيغة اللغة ");
define("v_customersms_description","هنا يمكن تحديد المراحل التي يتم فيها إشعار الحريف بواسطة رسالة، كما يمكن تخصيص نص الرسالة أيضا، يمكنك أيضا إضافة لغة جديدة لكل بلد على حدا، بالنسبة للبلدان التي لم يتم تعيين أي لغة لها سوف يتم استعمال اللغة الأساسية فيها تلقائيا");
define("v_customersms_addsms","إضافة صيغة نص الرسالة");
define("v_customersms_country","إختر البلد: ");
define("v_customersms_unicodesms","رسائل اليونيكود");
define("v_customersms_unicodetext","يتم تفعيل هذه الخاصية عند استعمال اللغة العربية أو الصينية أو اليونانية أو العبرية أو الكورية، إلخ. وكذلك عند استخدام الرموز في نص الرسالة (عموما نصوص اليونيكود تُمكِن من استعمال أحرف جميع اللغات بالإضافة الى جميع الرموز، عدد الأحرف الأقصى في نص الرسالة الواحدة يصبح 70 رمزا).");
define("v_customersms_orderstatus","حالة الطلبية");
define("v_customersms_smsactive","إرسال الإشعارات عبر الرسائل القصيرة نشط");
define("v_customersms_smsnotactive","إرسال الإشعارات عبر الرسائل القصيرة غير نشط، لتنشيطه اظغط على \"تفعيل\" في القائمة المرغوبة"); // edit
define("v_customersms_statusupdate"," تحيين حالة الطلبية ");
define("v_customersms_account","الحساب");
define("v_customersms_usernotactive","الحساب الشخصي غير نشط، للتسجيل يرجى النقر على ايقونة الرسائل، ومن ثمة يمكنك مشاهدة معطيات التسجيل، اذا سبق لك وأن استعملت هذا التطبيق واذا كنت تعرف اسم المستخدم وكلمة السر الخاصين بك يمكنك استخدامهم في هذا الحساب. خلافا لذلك أدخل البريد الإلكتروني الخاص بك ووافق على شروط الخدمة ومن ثمة اظغط على تسجيل");
define("v_customersms_invalidtext","نص الرسالة غير صالح");
define("v_customersms_smssaved","تم حفظ نص الرسالة");
define("v_customersms_smsdeleted","تم حذف صيغة نص الرسالة");
define("v_customersms_confirmdelete","هل أنت متأكد من عملية الحذف؟");
define("v_customersms_langdelete","حذف صيغة هذه اللغة");
define("v_customersms_smstext","نص الرسالة");
define("v_customersms_unicode","يونيكود");
define("v_customersms_versionfor","صيغة الرسالة الخاصة ب ");
define("v_customersms_wassaved"," تم تسجيله");
define("v_customersms_preview","معاينة");
define("v_customersms_active","تفعيل");
define("v_customersms_save","حفظ");
define("v_customersms_cancel","إلغاء");
define("v_customersms_jstotalsms","مجموع الرسائل:");
define("v_customersms_editlang","تحوير لغوي");
define("v_customersms_default","الوضع المبدئي");
define("v_customersms_edit","تحوير");
define("v_customersms_add","إضافة");
define("v_customersms_order","طلبية");
define("v_customersms_jschars","أحرف");
define("v_customersms_unicodesaved","تفعيل اليونيكود");
define("v_customersms_restoreunsaved","اعادة التغييرات غير المسجلة إلى حالتها الأصلية"); //new


//PayPal.php
define("v_paypal_credit","شراء مخزون الرسائل");
define("v_paypal_creditnotactive","شراء مخزون الرسائل - غير نشط");
define("v_paypal_usernotactive","الحساب الشخصي غير نشط، للتسجيل يرجى النقر على ايقونة الرسائل، ومن ثمة يمكنك مشاهدة معطيات التسجيل، اذا سبق لك وأن استعملت هذا التطبيق واذا كنت تعرف اسم المستخدم وكلمة السر الخاصين بك يمكنك استخدامهم في هذا الحساب. خلافا لذلك أدخل البريد الإلكتروني الخاص بك ووافق على شروط الخدمة ومن ثمة اظغط على تسجيل");
define("v_paypal_clickhereif"," اذا ما لم يتم عرض طرق الشراء بشكل صحيح يرجى الظغط هنا:"); //new



//SendSms.php
define("v_sendsms_bulksms","نص الرسائل القصيرة بالجملة");
define("v_sendsms_addrecipients","إضافة المستلمين  ");
define("v_sendsms_addtext","أضف قائمة المستلمين مع مراعاة الفصل بين كل مستلم وآخر بعلامة فاصل ","، يجب أن تكون الأرقام بالصيغة الدولية مع مراعاة حذف الأصفار وحذف علامة  "+" زائد");
define("v_sendsms_eg"," (مثلا 447971796595)");
define("v_sendsms_entertext","أكتب نص الرسالة");
define("v_sendsms_addcsv","CSV أضف المستلمين في صيغة");
...
define("v_sendsms_unicode"," يونيكود ");
define("v_sendsms_unicodetext","يتم تفعيل هذه الخاصية عند استعمال اللغة العربية أو الصينية أو اليونانية أو العبرية أو الكورية، إلخ. وكذلك عند استخدام الرموز في نص الرسالة (عموما نصوص اليونيكود تُمكِن من استعمال أحرف جميع اللغات بالإضافة الى جميع الرموز، عدد الأحرف الأقصى في نص الرسالة الواحدة يصبح 70 رمزا.).");
define("v_sendsms_time","التوقيت الخاص بك: ");
define("v_sendsms_time2","التوقيت: ");
define("v_sendsms_timezone","التوقيت المحلي: ");
define("v_sendsms_timezone2","اعدادات التوقيت المحلي");
define("v_sendsms_longtext","النص طويل");
define("v_sendsms_sendsms","ارسال");
define("v_sendsms_send","ارسال");
define("v_sendsms_sendtext","csv ارسال رسالة او رسائل بالجملة، أدخل ارقام الهواتف او قم بتحميل ملف بصيغة ");
define("v_sendsms_smsnotactive","بعث الرسائل - غير نشط");
define("v_sendsms_usernotactive","الحساب الشخصي غير نشط، للتسجيل يرجى النقر على ايقونة الرسائل، ومن ثمة يمكنك مشاهدة معطيات التسجيل، اذا سبق لك وأن استعملت هذا التطبيق واذا كنت تعرف اسم المستخدم وكلمة السر الخاصين بك يمكنك استخدامهم في هذا الحساب. خلافا لذلك أدخل البريد الإلكتروني الخاص بك ووافق على شروط الخدمة ومن ثمة اظغط على تسجيل");
define("v_sendsms_fillsms","أضف نص الرسالة");
define("v_sendsms_smslong","نص الرسالة طويل، الحد الأقصى المسموح به هو 612 حرف");
define("v_sendsms_unicodesmslong","نص الرسالة طويل، الحد الأقصى المسموح به هو 268 حرف يونيكود");
define("v_sendsms_wrongtime","تاريخ غير صالح لإرسال الرسائل");
define("v_sendsms_norecipients","عدد المستلمين الموجودين: 0");
define("v_sendsms_lowcreditall","ليس لدليك مخزون كافي لكي تبعث للكل ");
define("v_sendsms_recipients"," المستلمون");
define("v_sendsms_smssent","تم ارسال الرسالة");
define("v_sendsms_smssaved","تم حفظ نص الرسالة");
define("v_sendsms_wrongnumber","رقم خاطئ أو غير صالح");
define("v_sendsms_unauthorized","معرف الباعث غير صالح لتأكيد عملية الإرسال");
define("v_sendsms_lowcredit","مخزون منخفض لا يُمَكِن من بعث الرسائل");
define("v_sendsms_nounicode","اليونيكود غير مدعوم");
define("v_sendsms_cantconnect","لا يمكن التواصل مع سيرفر الرسائل");
define("v_sendsms_simulation","محاكاة الإرسال (تمت فقط محاكاة عملية الإرسال، لن يستقبل المستلم أي رسالة)");
define("v_sendsms_simulationconfirm","تم ارسال الرسالة (محاكاة)");
define("v_sendsms_error","خطأ");
define("v_sendsms_loginerror","خطأ في عملية الدخول");
define("v_sendsms_sendlater"," أرسل لاحقا ");
define("v_sendsms_jschars","أحرف: ");
define("v_sendsms_hr","1hr");
define("v_sendsms_date","التاريخ: ");

// SmsAnswers.php
define("v_smsanswers_smsanswers","ردود الرسائل");
define("v_smsanswers_description","الإجابة عن رسائل الحريف لا تظهر عادة الا عندما يستلم الحريف الرسالة من متجرك باستعمال صيغة \"الرقم النظامي\" وبذلك يمكن للحريف الرد باستعمال هاتفه الشخصي");
define("v_smsanswers_show","إظهار");
define("v_smsanswers_results","نتائج البحث ");
define("v_smsanswers_of"," ل ");
define("v_smsanswers_smscenter","مركز الرسائل");
define("v_smsanswers_date","التاريخ");
define("v_smsanswers_number","من الرقم");
define("v_smsanswers_new","جديد");
define("v_smsanswers_previous","السابق");
define("v_smsanswers_next","التالي");
define("v_smsanswers_page"," الصفحة: ");
define("v_smsanswers_smsnotactive","الإجابة عن الرسائل - غير نشطة");
define("v_smsanswers_usernotactive","الحساب الشخصي غير نشط، للتسجيل يرجى النقر على ايقونة الرسائل، ومن ثمة يمكنك مشاهدة معطيات التسجيل، اذا سبق لك وأن استعملت هذا التطبيق واذا كنت تعرف اسم المستخدم وكلمة السر الخاصين بك يمكنك استخدامهم في هذا الحساب. خلافا لذلك أدخل البريد الإلكتروني الخاص بك ووافق على شروط الخدمة ومن ثمة اظغط على تسجيل");
define("v_smsanswers_year","سنة");
define("v_smsanswers_month","شهر");
define("v_smsanswers_sms","رسالة");
define("v_smsanswers_text","نص:");
define("v_smsanswers_nosms","مجموع ردود الرسائل: 0");

// SmsHistory.php
define("v_smshistory_sent","الإرسال الى المستلم");
define("v_smshistory_error","خطأ");
define("v_smshistory_delivered","وصلت الرسالة الى المستلم");
define("v_smshistory_buffered","مستلم غير موجود"); //new
define("v_smshistory_smshistory","ارشيف الإرساليات");
define("v_smshistory_description","ارشيف الإرسال من تطبيق الإرساليات");
//define("v_smshistory_status","الحالة");
define("v_smshistory_adminsms"," ارساليات المشرف");
define("v_smshistory_customersms"," ارساليات الحريف");
define("v_smshistory_marketingsms"," الرسائل التجارية");
define("v_smshistory_simplesms"," إرسال عادي");
define("v_smshistory_show","إظهار");
define("v_smshistory_results","نتائج البحث ");
define("v_smshistory_of"," ل ");
define("v_smshistory_type","النوع");
define("v_smshistory_date","التاريخ");
define("v_smshistory_subject","موضوع الإرسالية");
define("v_smshistory_nubmer","الرقم");
define("v_smshistory_yes","نعم");
define("v_smshistory_no","لا");
define("v_smshistory_sysnumber","الرقم النظامي");
define("v_smshistory_balance","كمية المخزون:");
define("v_smshistory_customerdetail","إظهار معطيات الحريف");
define("v_smshistory_smstext","النص:");
define("v_smshistory_totalsms","مجموع الرسائل:");
define("v_smshistory_smsnotactive","أرشيف الإرسال - غير نشط");
define("v_smshistory_usernotactive","الحساب الشخصي غير نشط، للتسجيل يرجى النقر على ايقونة الرسائل، ومن ثمة يمكنك مشاهدة معطيات التسجيل، اذا سبق لك وأن استعملت هذا التطبيق واذا كنت تعرف اسم المستخدم وكلمة السر الخاصين بك يمكنك استخدامهم في هذا الحساب. خلافا لذلك أدخل البريد الإلكتروني الخاص بك ووافق على شروط الخدمة ومن ثمة اظغط على تسجيل");
define("v_smshistory_price","سعر الإرسالية بصيغة \"المخزون\"ـ");
define("v_smshistory_year","السنة");
define("v_smshistory_month","الشهر");
define("v_smshistory_status","الحالة");
define("v_smshistory_recipient","المستلم");
define("v_smshistory_unicode","يونيكود:");
define("v_smshistory_senderid","معرف المرسل:");
define("v_smshistory_previous","السابق");
define("v_smshistory_next","التالي");
define("v_smshistory_page"," الصفحة: ");
define("v_smshistory_nosms","مجموع الرسائل: 0");
define("v_smshistory_sms","الإرساليات");

// SmsMarketing.php
define("v_smsmarketing_smsbulk","الإرساليات التجارية - نص الإرساليات بالجملة");
define("v_smsmarketing_entertext","أدخل نص الرسالة");
define("v_smsmarketing_unicode"," يونيكود ");
define("v_smsmarketing_unicodetext","يتم تفعيل هذه الخاصية عند استعمال اللغة العربية أو الصينية أو اليونانية أو العبرية أو الكورية، إلخ. وكذلك عند استخدام الرموز في نص الرسالة (عموما نصوص اليونيكود تُمكِن من استعمال أحرف جميع اللغات بالإضافة الى جميع الرموز، عدد الأحرف الأقصى في نص الرسالة الواحدة يصبح 70 رمزا).");
define("v_smsmarketing_sendlater"," أرسل لاحقا ");
define("v_smsmarketing_yourtime","الوقت الخاص بك: ");
define("v_smsmarketing_jstotalcustomers","مجموع الحرفاء:");
define("v_smsmarketing_jstotalsms","مجموع الرسائل:");
define("v_smsmarketing_bulkfilter","الإرساليات التجارية - فلتر رسائل الجملة");
define("v_smsmarketing_allcustomers","جميع الحرفاء");
define("v_smsmarketing_companycustomers","منظومة الحرفاء");
define("v_smsmarketing_privatecustomers","حرفاء خاصون");
define("v_smsmarketing_allcountries","جميع الدول");
define("v_smsmarketing_lastname","اللقب:");
define("v_smsmarketing_firstname","الإسم:");
define("v_smsmarketing_lastname2","اللقب");
define("v_smsmarketing_firstname2","الإسم");
define("v_smsmarketing_groups","المجموعات:");
define("v_smsmarketing_all","الكل");
define("v_smsmarketing_gender","الجنس:");
define("v_smsmarketing_male","ذكر");
define("v_smsmarketing_female","أنثى");
define("v_smsmarketing_news","النشرة البريدية:");
define("v_smsmarketing_yes","نعم");
define("v_smsmarketing_no","لا");
define("v_smsmarketing_applyfilter","تفعيل الفلترة");
define("v_smsmarketing_birthfrom","تاريخ الولادة من: ");
define("v_smsmarketing_birthto","إلى: ");
define("v_smsmarketing_registerfrom","تاريخ التسجيل من: ");
define("v_smsmarketing_customersfound","الحرفاء الذين أمكن إيجادهم ");
define("v_smsmarketing_results","النتائج");
define("v_smsmarketing_action","الإجراء");
define("v_smsmarketing_mobilenr","رقم الهاتف المحمول");
define("v_smsmarketing_customerid","معرف الحريف");
define("v_smsmarketing_removecustomer","حذف الحريف من هذه القائمة");
define("v_smsmarketing_next","التالي");
define("v_smsmarketing_previous","السابق");
define("v_smsmarketing_page"," الصفحة: ");
define("v_smsmarketing_smsmarketingfound","الإرساليات التجاريت - عدد الحرفاء الذين أمكن إيجادهم ");
define("v_smsmarketing_description","أكتب نص الرسالة واستعمل الفلتر المتقدم لتحديد هدف حملة التسويق الخاصة بك.");
define("v_smsmarketing_smsmarketing","الإرساليات التجارية");
define("v_smsmarketing_smsnotactive","الإرساليات التسويقية - غير نشطة");
define("v_smsmarketing_usernotactive","الحساب الشخصي غير نشط، للتسجيل يرجى النقر على ايقونة الرسائل، ومن ثمة يمكنك مشاهدة معطيات التسجيل، اذا سبق لك وأن استعملت هذا التطبيق واذا كنت تعرف اسم المستخدم وكلمة السر الخاصين بك يمكنك استخدامهم في هذا الحساب. خلافا لذلك أدخل البريد الإلكتروني الخاص بك ووافق على شروط الخدمة ومن ثمة اظغط على تسجيل ");
define("v_smsmarketing_fillsms","إملأ نص الرسالة");
define("v_smsmarketing_smslong","نص الرسالة طويل (الحد الأقصى 612 حرفا).");
define("v_smsmarketing_unicodesmslong","نص الرسالة طويل (الحد الأقصى 268 حرف يونيكود).");
define("v_smsmarketing_nocustomers","الحرفاء الذين أمكن إيجادهم: 0");
define("v_smsmarketing_wrongtime","توقيت غير صالح لبعث الإرساليات");
define("v_smsmarketing_lowcreditall","ليس لديك مخزون إرساليات كافي لبعث الرسائل للجميع ");
define("v_smsmarketing_customers"," الحرفاء");
define("v_smsmarketing_smssent","تم بعث الإرسالية");
define("v_smsmarketing_smssaved","تم حفظ الإرسالية.");
define("v_smsmarketing_wrongnr","رقم غير صالح أو غير موجود");
define("v_smsmarketing_unauthorized","معرف المرسل غير مسموح به لتأكيد عملية الإرسال");
define("v_smsmarketing_lowcredit","مخزون إرساليات منخفض");
define("v_smsmarketing_nounicode","اليونيكود غير مدعم");
define("v_smsmarketing_cantconnect","لا يمكن الإتصال بسرفر الإرساليات");
define("v_smsmarketing_simulation","محاكاة الإرسال (تمت فقط محاكاة عملية الإرسال، لن يستقبل المستلم أي رسالة)");
define("v_smsmarketing_simulationconfirm","تم بعث الرسالة (فقط محاكاة)");
define("v_smsmarketing_error","خطأ");
define("v_smsmarketing_loginerror","خطأ في عملية الدخول");
define("v_smsmarketing_date","التاريخ:");
define("v_smsmarketing_time","التوقيت: ");
define("v_smsmarketing_hr","1hr");
define("v_smsmarketing_timezone","التوقيت المحلي: ");
define("v_smsmarketing_timezone2","إعدادات التوقيت المحلي");
define("v_smsmarketing_send","إرسال");
define("v_smsmarketing_jschars","أحرف: ");
define("v_smsmarketing_longtext","النص طويل");
define("v_smsmarketing_typ","النوع: ");
define("v_smsmarketing_country","البلد:");
define("v_smsmarketing_city","الجهة:");
define("v_smsmarketing_advert","الإعلام:");
define("v_smsmarketing_store","المتجر:"); //new
define("v_smsmarketing_allstores","جميع المتاجر"); //new

// smsprestashop.php
define("v_smsprestashop_prestashop","Presta SMS");
define("v_smsprestashop_description","presta-sms.com - إبعث إرسالياتك من برستاشوب!");
define("v_smsprestashop_admin","إرساليات المشرف");
define("v_smsprestashop_customer","إرساليات الحريف");
define("v_smsprestashop_settings","إعدادات الإرسال");
define("v_smsprestashop_history","أرشيف الإرسال");
define("v_smsprestashop_credit","شراء مخزون الإرساليات");
define("v_smsprestashop_marketing","الإرساليات التجارية");
define("v_smsprestashop_answers","ردود الرسائل");
define("v_smsprestashop_send","بعث الإرساليات");
define("v_smsprestashop_about","حول التطبيق");
define("v_smsprestashop_wrongnr","رقم خاطئ أو غير موجود");
define("v_smsprestashop_unauthorized","معرف الباعث غير مسموح به لتأكيد عملية الإرسال");
define("v_smsprestashop_lowcredit","مخزون الإرساليات منخفض لإرسال الرسائل");
define("v_smsprestashop_nounicode","لا يمكن استعمال اليونيكود");
define("v_smsprestashop_loginerror","خطأ في عملية الدخول");
define("v_smsprestashop_cantconnect","لا يمكن الإتصال بسيرفر الإرساليات");
define("v_smsprestashop_simulation","محاكاة الإرسال (تمت فقط محاكاة عملية الإرسال، لن يستقبل المستلم أي رسالة)");
define("v_smsprestashop_nrunknown","لم يتم التعرف على رقم الهاتف المحمول");
define("v_smsprestashop_notconnected","الإتصال مقطوع مع سيرفر الإرساليات");
define("v_smsprestashop_sqlinfo1","طلبيات جديدة");
