...
class ModelBlogComment extends Model {
	public function addComment($data) {
		...
		$this->event->trigger('post.admin.comment.add', $blog_comment_id);
	...
	public function editComment($blog_comment_id, $data) {
		...
		$this->event->trigger('post.admin.comment.edit', $blog_comment_id);
	}

	public function deleteComment($blog_comment_id) {
		$this->event->trigger('pre.admin.comment.delete', $blog_comment_id);
