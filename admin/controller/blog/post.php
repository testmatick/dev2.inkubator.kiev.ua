...
class ControllerBlogPost extends Controller {
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $blog_post_id) {
			if ($this->config->get('config_account_id') == $blog_post_id) {
				$this->error['warning'] = $this->language->get('error_account');
			}

			if ($this->config->get('config_checkout_id') == $blog_post_id) {
				$this->error['warning'] = $this->language->get('error_checkout');
			}

			if ($this->config->get('config_affiliate_id') == $blog_post_id) {
				$this->error['warning'] = $this->language->get('error_affiliate');
			}

			if ($this->config->get('config_return_id') == $blog_post_id) {
