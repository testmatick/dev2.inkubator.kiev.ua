...
class ControllerTltBlogTltBlog extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('tltblog/tltblog', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('tltblog/tltblog', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('tltblog/tltblog/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['copy'] = $this->url->link('tltblog/tltblog/copy', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('tltblog/tltblog/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			...
			foreach ($tags as $tagvalue) {
				$tagsdata[] = array(
					...
					'href'		=> $this->url->link('tltblog/tlttag/edit', 'token=' . $this->session->data['token'] . '&tlttag_id=' . $tagvalue['tlttag_id'], 'SSL')
				);	
			}
			...
			$data['tltblogs'][] = array(
				...
				'edit'       => $this->url->link('tltblog/tltblog/edit', 'token=' . $this->session->data['token'] . '&tltblog_id=' . $result['tltblog_id'] . $url, 'SSL')
			);			
		}
		...
		$data['sort_title'] = $this->url->link('tltblog/tltblog', 'token=' . $this->session->data['token'] . '&sort=bd.title' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('tltblog/tltblog', 'token=' . $this->session->data['token'] . '&sort=b.status' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('tltblog/tltblog', 'token=' . $this->session->data['token'] . '&sort=b.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('tltblog/tltblog', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('tltblog/tltblog_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['tltblog_id'])) {
			$data['action'] = $this->url->link('tltblog/tltblog/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('tltblog/tltblog/edit', 'token=' . $this->session->data['token'] . '&tltblog_id=' . $this->request->get['tltblog_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('tltblog/tltblog', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('tltblog/tltblog_form.tpl', $data));
	}
