                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 300px;"><?php echo $text_action; ?></td>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if ($extensions) { ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <a href="<?php echo $extension['open']; ?>" data-toggle="tooltip" title="<?php echo $text_open; ?>" class="btn btn-info<?php if (!$extension['installed']){ ?> disabled<?php } ?>"><i class="fa fa-pencil"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php } ?>
