              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <textarea name="tltblog_description[<?php echo $language['language_id']; ?>][intro]" placeholder="<?php echo $entry_intro; ?>" id="input-intro<?php echo $language['language_id']; ?>"><?php echo isset($tltblog_description[$language['language_id']]) ? $tltblog_description[$language['language_id']]['intro'] : ''; ?></textarea>                      
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="tltblog_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>"><?php echo isset($tltblog_description[$language['language_id']]) ? $tltblog_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
