              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($article['article_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                <?php if ($article['href']) { ?>
                <td class="text-left"><?php echo $article['indent']; ?><a href="<?php echo $article['href']; ?>"><?php echo $article['name']; ?></a></td>
              <?php } else { ?>
                <td class="text-left"><?php echo $article['indent']; ?><?php echo $article['name']; ?></td>
              <?php } ?>
