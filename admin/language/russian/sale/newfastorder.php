...
$_['text_newfastorder_url']   	= 'URL с которого заказали товар';
...
$_['number_order_id']        	= 'НОМЕР ЗАКАЗА';
$_['text_number_order_id_']     = '№ ЗАКАЗА - ';
...
$_['entry_icon_send_fastorder'] 								= 'Изменить иконку на кнопке Оформить заявку:';
$_['entry_background_button_send_fastorder'] 					= 'Изменить Цвет кнопки Оформить заявку:';
$_['entry_background_button_send_fastorder_hover'] 				= 'Изменить Цвет кнопки Оформить заявку при наведении:';
