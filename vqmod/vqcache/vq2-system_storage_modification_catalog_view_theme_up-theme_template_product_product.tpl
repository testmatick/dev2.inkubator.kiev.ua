      ...
      <div class="row">
        ...
        <?php } ?>  
          ...
          <ul class="thumbnails">
            ...
            <a class="cloud-zoom thumbnail" href="<?php echo $popup; ?>" title="<?php echo $custom_imgtitle; ?>" id='zoom1' rel="position:'inside', adjustX: 15, adjustY: 0, tint:'#ffffff', tintOpacity:0.1, smoothMove:3, showTitle:false">
            <img src="<?php echo $thumb; ?>" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $custom_alt; ?>" class="img-responsive img-<?php echo $config->get('t1d_img_style'); ?>" id="image" />
            </a>
            </li>
            <?php } ?>
          </ul>
          ...
          <ul class="image-additional-wrapper thumbnails">
            ...
            <img src="<?php echo $thumb; ?>" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $custom_alt; ?>" class="img-responsive img-<?php echo $config->get('t1d_img_style'); ?>" /></a>
            </div>  
            </li>
            <?php foreach ($images as $image) { ?>
            <li class="image-additional col-sm-12">
            <div>
            <a class="cloud-zoom-gallery" href="<?php echo $image['popup']; ?>" title="<?php echo $custom_imgtitle; ?>" rel="useZoom: 'zoom1', smallImage: '<?php echo $image['thumb']; ?>' ">
            <img src="<?php echo $image['thumb']; ?>" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $custom_alt; ?>" class="img-responsive img-<?php echo $config->get('t1d_img_style'); ?>" />
            </a>
            </div>
            </li>
            <?php } ?>
...
--></script>
          ...
          <ul class="thumbnails">      
            ...
            <a class="cloud-zoom thumbnail" href="<?php echo $popup; ?>" title="<?php echo $custom_imgtitle; ?>" id='zoom1' rel="position:'inside', adjustX: 10, adjustY: 0, tint:'#ffffff', tintOpacity:0.1, smoothMove:3, showTitle:false">
            <img src="<?php echo $thumb; ?>" title="<?php echo $custom_imgtitle; ?>" alt="<?php echo $custom_alt; ?>" class="img-responsive img-<?php echo $config->get('t1d_img_style'); ?>" id="image" />
            </a>
            </li>
            <?php } ?>
